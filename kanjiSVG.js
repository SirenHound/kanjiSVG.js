...
// @namespace    KanjiSVG
// @version      0.2
// @description  kanji svg canvas
// @author       Aaron Drew
// @grant        none
// @license        MIT
// ==/UserScript==

var boringVariable = 1;
function boringFunction(me){
    return me || "";
}

var pathTo = "https://rawgit.com/SirenHound/nippongrammar/master";
var kanjiSvg = new (function(pathToArg) {
	var kanjiSvg = {};
	var kanjiSvgLoading = [];
	var kanjiSvgLoaded = [];
	var kanjiSvgQueue = [];
